...
class RectangleHandler:
    ...
    def select_rectangle(self, event):
        ...
        try:
            for rect in self.rectangles:
                if rect.mouse_collide() is False and rect.normal_size is False:
            ...
            pass
        if self.colliding is False and mouse.get_pressed()[0] is False:
            try:
        ...
        try:
            ...
            elif self.selected_rectangle.mouse_collide() and mouse.get_pressed()[2]:
                self.selected_rectangle.selected = False
        except AttributeError:
            pass
